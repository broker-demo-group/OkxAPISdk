...
public class TradingBigData {
    ...
    public <T> List<T> getSupportCoins(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
        List<T> result = commonAPICaller.listExecute(apiRequestPayload,"GET","/api/v5/rubik/stat/trading-data/support-coin",clazz);
        return  result;
    }

    public <T> List<T> getTakerVolume(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
        List<T> result = commonAPICaller.listExecute(apiRequestPayload,"GET","/api/v5/rubik/stat/taker-volume",clazz);
        return  result;
    }

    public <T> List<T> getLoanRatio(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
        List<T> result = commonAPICaller.listExecute(apiRequestPayload,"GET","/api/v5/rubik/stat/margin/loan-ratio",clazz);
        return  result;
    }

    public <T> List<T> getContractsLongShortAccountRatio(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
    ...
    public <T> List<T> getContractsOpenInterestVolume(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
        List<T> result = commonAPICaller.listExecute(apiRequestPayload,"GET","/api/v5/rubik/stat/contracts/open-interest-volume",clazz);
        return  result;
    }

    public <T> List<T> getOptionOpenInterestVolume(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
        List<T> result = commonAPICaller.listExecute(apiRequestPayload,"GET","/api/v5/rubik/stat/option/open-interest-volume",clazz);
        return  result;
    }

    public <T> List<T> getOptionOpenInterestVolumeRatio(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
    ...
    public <T> List<T> getOptionOpenInterestVolumeExpiry(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
    ...
    public <T> List<T> getOptionOpenInterestVolumeStrike(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
    ...
    public <T> List<T> getOptionTakerBlockVolume(APIRequestPayload apiRequestPayload, Class<T> clazz)  {
